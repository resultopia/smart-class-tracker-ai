...
import { Shield, User, Lock, Calendar, CheckCircle, Users, BookOpen } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-white p-12 text-center">
          ...
          <div className="space-y-4 text-left max-w-sm">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-blue-100">Real-time attendance tracking</span>
            </div>
            <div className="flex items-center space-x-3">
              <Users className="h-5 w-5 text-green-300" />
              <span className="text-blue-100">Multi-role access control</span>
            </div>
            <div className="flex items-center space-x-3">
        ...
        <div className="absolute bottom-20 left-20 w-16 h-16 bg-white/10 rounded-full animate-pulse delay-1000"></div>
      </div>
